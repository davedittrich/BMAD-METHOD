...
T. Edward "Ed" Damer (August 16, 1937 - March 21, 2024) was an American philosopher and author of "Attacking Faulty Reasoning," a widely-used textbook on logical fallacies used in college courses on logic, critical thinking, argumentation, and philosophy. The book explains 60 of the most commonly committed fallacies using Damer's systematic approach.

## Core Philosophy

Damer's approach defines **a fallacy as a violation of one or more of the five criteria of a good argument**. This systematic framework provides both a method for constructing strong arguments and for identifying weaknesses in faulty reasoning.
...
- Genetic fallacy (rejecting claims based on irrelevant origins)
- Appeal to tradition or novelty
- Straw man (misrepresenting opponent's position)
- Appeal to authority (citing irrelevant or false authority)
...
- Types:
  ...
  - Anger: Using outrage instead of reasoning
...
- Key terms are clearly and consistently defined
...
- Division/composition fallacies
...
- False analogies used as primary evidence
...
- Refutations are supported by evidence
...
- Appeal to hypocrisy (focusing on opponent's inconsistency)
...
12. **Resolution Principle**: Consider an issue resolved when one argument meets structural and evidential standards more successfully than alternatives
...
4. **Map logical connections** between premises and conclusion
5. **Make hidden assumptions explicit** as additional premises
...
- **Evaluation**: Simplifies application of five criteria
- **Improvement**: Identifies specific areas needing strengthening
...
4. **Counterargument planning**: Anticipate and prepare responses
...
4. **Fallacy identification**: Note specific criterion violations
...
4. **Resolution recognition**: Acknowledge when evidence sufficiently supports conclusions
5. **Graceful engagement**: Accept challenges and concede when appropriate

## Three Methods for Attacking Fallacies
...
- **Example**: "By that reasoning, since some doctors make mistakes, we should never trust any medical advice."
...
- **Professional development**: Framework for clear business and academic communication
...
4. **Completeness**: Is important information being omitted?
...
### Assessment Framework Using Damer's Method:
...
- **Quality assurance**: Framework for reviewing important communications and decisions

This framework provides a comprehensive, systematic approach to both constructing strong arguments and identifying weaknesses in faulty reasoning, making it an invaluable tool for anyone engaged in serious intellectual discourse.