...
While the BMad Method is designed for software development, it can be used for any project that can be broken down into a series of tasks. For example, the Reporting and Writing Expansion Pack is a non-technical expansion pack that can be used to manage a writing project.
