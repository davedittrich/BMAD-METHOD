...
2.  **Enhanced Lifecycle Status Assessment**
    -   Read project metadata from `.bmad/projects/{project-name}/config/project.json` with lifecycle information
...
4.  **Cross-Project Relationship Status**
    -   Display project relationships from `.bmad/projects/{project-name}/config/relationships.json`
...
6.  **Analysis Inventory Assessment**
    -   List completed analyses in `.bmad/projects/{project-name}/analyses/`
