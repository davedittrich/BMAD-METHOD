...
2. **Directory Structure Creation**
   - Create `.bmad/projects/{project-name}/` base directory
   - Create subdirectories: `references/`, `analyses/`, `drafts/`, `config/`
   - Ensure directory creation follows existing module patterns
...
3. **Project Metadata Initialization**
   ...
   - Store metadata in `.bmad/projects/{project-name}/config/project.json`
