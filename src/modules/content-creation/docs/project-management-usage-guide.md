# BMAD Content Creation Module - Project Management Usage Guide
...
### Core Analysis Tasks (Project-Aware)

```
save-transcript                 # Save YouTube transcripts to project
write-video-script              # Create video scripts within project context
verify-facts                    # Fact verification with project integration
```
...
4. Run analysis workflows # Generate analysis
...
**Research Article Workflow Integration**:

```
1. Set project context: project-switch
2. Gather sources: save-transcript, project-add-source
3. Run research-article workflow
4. Analysis outputs saved to project/analyses/
5. Track progress: project-status
```

**Video Production Workflow Integration**:

```
1. Set project context for video series
2. Gather reference materials
3. Run create-video-assets workflow
4. Scripts saved to project/drafts/
5. Use project-link to connect related videos
```

**Multi-Platform Content Integration**:

```
1. Create main content project
2. Use research-article for core content
3. Use create-video-assets for video adaptation
4. Use adapt-for-social-media for platform versions
5. Link all related projects
6. Track entire campaign: project-insights
```
...
```
- Set project context before starting workflows
- Use consistent project structure across team
- Leverage project-link for related content
- Regular use of project-insights for overview
...
- Team Structure Guide: Agent coordination patterns
- Transcript Workflow Guide: Video analysis workflows
- Task Documentation: Comprehensive usage instructions
```
...
The BMAD Content Creation Module Project Management System transforms research from a linear process into an organized, scalable, and collaborative workflow. Key benefits include:
...
✅ **Workflow Integration**: Seamless integration with all content creation workflows

Start with basic project creation and gradually adopt advanced features as they become natural to your workflow. The system is designed to enhance productivity while maintaining the simplicity and flexibility that makes BMAD Content Creation module effective.
