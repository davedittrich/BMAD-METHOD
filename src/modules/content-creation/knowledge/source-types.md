# Source Types Reference Guide

## Primary Sources

### Definition and Characteristics

**Primary sources** provide firsthand evidence about an event, object, person, or work of art. They are created by witnesses or recorders who experienced the events or conditions being documented.
...
- Examine provenance and chain of custody
...
- Consider the purpose for which the source was created
- Examine the circumstances of creation

## Secondary Sources

### Definition and Characteristics

**Secondary sources** interpret, analyze, or summarize primary sources. They are created by people who did not directly experience the events or phenomena being discussed.

### Types of Secondary Sources

**Academic and Scholarly Works**

- Peer-reviewed journal articles, books, dissertations
...
- Review citation practices and source attribution
- Consider publication standards and guidelines

## Tertiary Sources

### Definition and Characteristics

**Tertiary sources** compile and organize primary and secondary sources. They typically provide overviews, summaries, or directories of information.
...
- Library catalogs and finding aids
...
- Resource lists and link collections
- Subject guides and taxonomies
...
- Review editorial policies and standards
...
- Review editorial oversight processes
- Consider transparency in source selection
...
- Commercial sites (.com) - evaluate for commercial bias
...
- Instagram - visual content with limited context
...
- Assess the credibility of shared content
...
- Administrative records (regulations, data, reports)
...
- Newsletter writer expertise and sources
- Citizen journalism quality and verification
...
- Publication timeline and revision process
...
- Replication potential and verification
...
- Varying legal and regulatory environments
- Cultural communication norms and expectations

## Source Hierarchy and Reliability

### Academic Research Hierarchy

1. **Highest Reliability**: Peer-reviewed primary research studies
2. **High Reliability**: Meta-analyses and systematic reviews
3. **Good Reliability**: Peer-reviewed secondary sources
4. **Moderate Reliability**: Reputable non-peer-reviewed sources
5. **Lower Reliability**: Popular press and general media
6. **Lowest Reliability**: Unverified online sources and personal blogs

### News and Media Hierarchy

1. **Highest Reliability**: Established newspapers with strong editorial standards
2. **High Reliability**: Reputable magazines and broadcast news organizations
3. **Good Reliability**: Specialized trade and professional publications
4. **Moderate Reliability**: Online news sites with editorial oversight
5. **Lower Reliability**: Blogs and personal websites
6. **Lowest Reliability**: Social media posts and unverified online content
...
- Technical topics: Professional and trade sources most relevant
...
- Technology: Technical information becomes outdated quickly
- Social trends: Cultural and social information evolves rapidly

## Best Practices for Source Evaluation
...
- Cross-reference facts across different source types
...
- Balance expert opinion with practical experience
...
- Specify version numbers for changing documents
...
- Note any corrections or updates to sources
- Keep backup copies of important sources
